...
{
    public partial class MenuRunner_Window : Form
    {
        public MenuRunner_Window()
        {
            InitializeComponent();
        ...
        {
            DialogResult result = MessageBox.Show("Уважаемый, вы действительно хотите покинуть свой профиль в системе?",
        ...
        private void MenuRunner_Window_KeyDown(object sender, KeyEventArgs e)
        {
